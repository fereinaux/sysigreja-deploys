...
namespace SysIgreja.Controllers
{
    public class InscricoesController : Controller
    {
        ...
        public ActionResult LogoByNome(string nome)
        {
            ...
            if (arquivo != null)
            {
                return File(imageService.ResizeImage(arquivo.Conteudo,100), arquivo.Tipo, arquivo.Nome);
            }
            else
            {
                return null;
        ...
        public ActionResult BackgroundByNome(string nome)
        {
            ...
            if (arquivo != null)
            {
                return File(imageService.ResizeImage(arquivo.Conteudo, 400), arquivo.Tipo, arquivo.Nome);
            }
            else
            {
                return null;
        ...
        public ActionResult GetBGEventoGlobal(int Id)
        {
            ...
            return File(imageService.ResizeImage(evento.Background, 400), "image/jpeg", "Background");
        }
        ...
        public ActionResult PagamentoConcluido(string external_reference, string payment_id)
        {
            ...
            if (
                participantesBusiness
                    .GetParticipantes()
                    .Any(x => x.MercadoPagoId == external_reference)
                || equipesBusiness
            ...
            )
            {
                Participante participante = participantesBusiness
                    .GetParticipantes()
                    .FirstOrDefault(x => x.MercadoPagoId == external_reference);

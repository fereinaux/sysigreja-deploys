...
namespace SysIgreja
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            // jQuery
            bundles.Add(
                new ScriptBundle("~/bundles/jquery").Include("~/Scripts/jquery-3.1.1.min.js")
            );

            // jsCrop
            bundles.Add(
                new ScriptBundle("~/bundles/jscrop").Include(
            ...
            // jsCropCSS
            bundles.Add(
                new StyleBundle("~/bundles/jscropcss").Include(
            ...
            bundles.Add(
                new ScriptBundle("~/bundles/imaskjs").Include("~/Scripts/plugins/imaskjs/imask.js")
            );

            // Inspinia script
            bundles.Add(
                new ScriptBundle("~/bundles/inspinia").Include(
            ...
            bundles.Add(
                new Bundle("~/bundles/util").Include(
            ...
            bundles.Add(
                new ScriptBundle("~/plugins/jsPDF").Include(
            ...
            bundles.Add(
                new ScriptBundle("~/plugins/html2canvas").Include(
            ...
            // validate
            bundles.Add(
                new ScriptBundle("~/plugins/validate").Include(
            ...
            bundles.Add(
                new ScriptBundle("~/plugins/dataTables").Include(
                    ...
                    "~/Scripts/plugins/dataTables/datatable-config-v12.js",
            ...
            // dataPicker styles
            bundles.Add(
                new StyleBundle("~/plugins/dataPickerStyles").Include(
            ...
            // dataPicker
            bundles.Add(
                new ScriptBundle("~/plugins/dataPicker").Include(
            ...
            // ChartJs
            bundles.Add(
                new ScriptBundle("~/bundles/chartjs").Include(
            ...
            // chosen styles
            bundles.Add(
                new StyleBundle("~/Content/plugins/chosen/chosenStyles").Include(
            ...
            // chosen
            bundles.Add(
                new ScriptBundle("~/plugins/chosen").Include(
            ...
            // iCheck css styles
            bundles.Add(
                new StyleBundle("~/Content/plugins/iCheck/iCheckStyles").Include(
            ...
            // iCheck
            bundles.Add(
                new ScriptBundle("~/plugins/iCheck").Include(
            ...
            //SweetAlert
            bundles.Add(
                new ScriptBundle("~/bundles/sweetalert").Include(
            ...
            //SweetAlert Css
            bundles.Add(
                new StyleBundle("~/plugins/sweetalert").Include(
                    "~/Content/plugins/sweetalert/sweetalert.css"
                )
            );

            bundles.Add(
                new StyleBundle("~/bundle/jasny").Include(
                    "~/Content/plugins/jasny/jasny-bootstrap.min.css"
                )
            );

            bundles.Add(
                new ScriptBundle("~/plugins/jasny").Include(

    ...
    public class MapperRealidade
    {
        ...
        public MapperRealidade()
        {
            var configuration = new MapperConfiguration(cfg =>
            {
                cfg.CreateMap<Configuracao, EventoClaimModel>()
                    ...
                    .ForMember(
                        dest => dest.EquipeCirculo,
                        opt => opt.MapFrom(x => x.EquipeCirculo.Nome)
                    )
                    .ForMember(
                ...
                cfg.CreateMap<Lancamento, LancamentosViewModel>()
                    .ForMember(
                        ...
                        opt => opt.MapFrom(x => x.CentroCusto.Descricao)
                    )
                    .ForMember(
                        dest => dest.Evento,
                        opt =>
                            opt.MapFrom(x => $"{x.Evento.Configuracao.Titulo} {x.Evento.Numeracao}")
                    )
                    .ForMember(
                        dest => dest.Descricao,
                        opt => opt.MapFrom(x => UtilServices.CapitalizarNome(x.Descricao))
                    )
                    .ForMember(
                        dest => dest.Origem,
                        opt => opt.MapFrom(x => UtilServices.CapitalizarNome(x.Origem))
                    )
                    .ForMember(
                    ...
                    .ForMember(
                        ...
                        opt => opt.MapFrom(x => x.MeioPagamento.Descricao)
                    )
                    .ForMember(
                        dest => dest.Valor,
                        opt => opt.MapFrom(x => UtilServices.DecimalToMoeda(x.Valor))
                ...
                cfg.CreateMap<Equipante, CrachaCasalModel>()
                    ...
                    .ForMember(
                        dest => dest.Apelido,
                        opt => opt.MapFrom(x => UtilServices.CapitalizarNome(x.Dupla))
                    )
                    .ForMember(
                        dest => dest.Foto,
                        opt =>
     ...
     .ForMember(dest => dest.Equipe, opt => opt.MapFrom(x => (x.Equipe.Nome)));
                cfg.CreateMap<EquipanteEvento, CrachaCasalModel>()
                    ...
                    .ForMember(
                        dest => dest.Apelido,
                        opt => opt.MapFrom(x => UtilServices.CapitalizarNome(x.Equipante.Dupla))
                    )
                    .ForMember(
                        dest => dest.Foto,
                        opt =>
                ...
                cfg.CreateMap<Quarto, PostQuartoModel>()
                    .ForMember(
                        dest => dest.Equipante,
                        opt => opt.MapFrom(x => x.Equipante != null ? x.Equipante.Nome : "")
                    );
                ...
                cfg.CreateMap<Participante, ParticipanteExcelViewModel>()
                    ...
                    .ForMember(
                        dest => dest.Padrinho,
                        opt => opt.MapFrom(x => x.Padrinho.EquipanteEvento.Equipante.Nome ?? "")
                    )
                    .ForMember(
                        dest => dest.Situacao,
                        opt => opt.MapFrom(x => x.Status.GetDescription())
                ...
                cfg.CreateMap<CirculoParticipante, EquipanteListModel>()
                    ...
                    .ForMember(
                        dest => dest.Apelido,
                        opt =>
                            opt.MapFrom(x => UtilServices.CapitalizarNome(x.Participante.Apelido))
                    )
                    .ForMember(
                        dest => dest.Etiquetas,
                        opt =>
                    ...
                    .ForMember(
                        dest => dest.Idade,
                        opt => opt.MapFrom(x => UtilServices.GetAge(x.Participante.DataNascimento))
                    )
                    .ForMember(
                        dest => dest.Sexo,
                        opt => opt.MapFrom(x => x.Participante.Sexo.GetDescription())
                    )
                    .ForMember(
                        dest => dest.HasFoto,
                        opt => opt.MapFrom(x => x.Participante.Arquivos.Any(y => y.IsFoto))
                    )
                    .ForMember(
                        dest => dest.Faltas,
                        opt =>
                    ...
                    .ForMember(
                        dest => dest.QtdAnexos,
                        opt => opt.MapFrom(x => x.Participante.Arquivos.Count())
                    );
                cfg.CreateMap<ApplicationUser, EquipanteUser>()
                    ...
                    .ForMember(
                        dest => dest.Idade,
                        opt => opt.MapFrom(x => UtilServices.GetAge(x.Equipante.DataNascimento))
                    )
                    .ForMember(
                        dest => dest.Sexo,
                        opt => opt.MapFrom(x => x.Equipante.Sexo.GetDescription())
                    );
                ...
                cfg.CreateMap<EquipanteEvento, EquipanteListModel>()
                    ...
                    .ForMember(
                        dest => dest.Fone,
                        opt => opt.MapFrom(x => UtilServices.CapitalizarNome(x.Equipante.Fone))
                    )
                    .ForMember(
                    ...
                    .ForMember(
                        dest => dest.HasFoto,
                        opt => opt.MapFrom(x => x.Equipante.Arquivos.Any(y => y.IsFoto))
                    )
                    .ForMember(
                        dest => dest.HasOferta,
                        opt =>
                    ...
                    .ForMember(
                        dest => dest.QtdAnexos,
                        opt => opt.MapFrom(x => x.Equipante.Arquivos.Count())
                    )
                    .ForMember(dest => dest.Tipo, opt => opt.MapFrom(x => x.Tipo.GetDescription()))
                    ...
                    .ForMember(
                        dest => dest.Longitude,
                        opt => opt.MapFrom(x => x.Equipante.Longitude)
                    )
                    .ForMember(dest => dest.Latitude, opt => opt.MapFrom(x => x.Equipante.Latitude))
                    .ForMember(
                        dest => dest.Referencia,
                        opt => opt.MapFrom(x => x.Equipante.Referencia)
                    )
                    ...
                    .ForMember(
                        dest => dest.HasConvenio,
                        opt => opt.MapFrom(x => x.Equipante.HasConvenio)
                    )
                    .ForMember(dest => dest.Convenio, opt => opt.MapFrom(x => x.Equipante.Convenio))
                    .ForMember(
                        dest => dest.Hospitais,
                        opt => opt.MapFrom(x => x.Equipante.Hospitais)
                    )
                    .ForMember(
                        dest => dest.Quarto,
                        opt =>
                    ...
                    .ForMember(
                        dest => dest.HasParente,
                        opt => opt.MapFrom(x => x.Equipante.HasParente)
                    )
                    ...
                    .ForMember(
                        dest => dest.StatusMontagem,
                        opt => opt.MapFrom(x => x.StatusMontagem.GetDescription())
                    );
                cfg.CreateMap<EquipanteEvento, PostEquipanteModel>()
                    ...
                    .ForMember(
                        dest => dest.DataNascimento,
                        opt => opt.MapFrom(x => x.Equipante.DataNascimento)
                    )
                    .ForMember(
                        dest => dest.HasRestricaoAlimentar,
                        opt => opt.MapFrom(x => x.Equipante.HasRestricaoAlimentar)
                    )
                    .ForMember(
                        dest => dest.RestricaoAlimentar,
                        opt => opt.MapFrom(x => x.Equipante.RestricaoAlimentar)
                    )
                    .ForMember(
                        dest => dest.HasMedicacao,
                        opt => opt.MapFrom(x => x.Equipante.HasMedicacao)
                    )
                    .ForMember(
                        dest => dest.Medicacao,
                        opt => opt.MapFrom(x => x.Equipante.Medicacao)
                    )
                    .ForMember(
                        dest => dest.HasAlergia,
                        opt => opt.MapFrom(x => x.Equipante.HasAlergia)
                    )
                    ...
                    .ForMember(
                        dest => dest.DataCasamento,
                        opt => opt.MapFrom(x => x.Equipante.DataCasamento)
                    )
                    ...
                    .ForMember(
                        dest => dest.NomeContato,
                        opt => opt.MapFrom(x => x.Equipante.NomeContato)
                    )
                    .ForMember(
                        dest => dest.FoneContato,
                        opt => opt.MapFrom(x => x.Equipante.FoneContato)
                    )
                    .ForMember(
                        dest => dest.NomeConvite,
                        opt => opt.MapFrom(x => x.Equipante.NomeConvite)
                    )
                    .ForMember(
                        dest => dest.FoneConvite,
                        opt => opt.MapFrom(x => x.Equipante.FoneConvite)
                    )
                ...
                cfg.CreateMap<EquipanteEvento, EquipanteExcelModel>()
                    ...
                    .ForMember(
                        ...
                        opt => opt.MapFrom(x => x.Equipante.Complemento)
                    )
                    .ForMember(
                        dest => dest.Referencia,
                        opt => opt.MapFrom(x => x.Equipante.Referencia)
                    ...
                    .ForMember(
                        dest => dest.Tipo,
                        opt => opt.MapFrom(x => (x.Tipo.GetDescription()))
                    )
                    .ForMember(
                        dest => dest.Situacao,
                        opt =>

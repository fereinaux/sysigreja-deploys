    ...
    public class HomeController : SysIgrejaControllerBase
    {
        ...
        public ActionResult GetResultadosAdmin(int EventoId)
        {
            ...
            var result = new
            {
                ...
                MeiosPagamento = lancamentoBusiness.GetLancamentos().Where(x => x.EventoId == EventoId && x.Valor > 0).ToList().Select(x => UtilServices.CapitalizarNome(x.MeioPagamento.Descricao)).Distinct(),
                ...
                .Select(x => new
                {
                    ...
                    MeioPagamento = UtilServices.CapitalizarNome(x.MeioPagamento),
                    Valor = x.Valor
                })
